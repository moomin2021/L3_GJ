...
void PieceManager::Initialize()
{
	...
	pieceIndex[Piece_I].blockData = { n,n,n,c };
	...
	pieceIndex[Piece_L].blockData = { c,n,n,n };
	...
	pieceIndex[Piece_J].blockData = { n,n,n,c };
	...
	pieceIndex[Piece_O].blockData = { n,n,c,n };
	...
	pieceIndex[Piece_S].blockData = { n,n,n,c };
	...
	pieceIndex[Piece_T].blockData = { n,n,n,c };
	...
	pieceIndex[Piece_Z].blockData = { c,n,n,n };
